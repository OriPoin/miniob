...
void VacuousTrxKit::all_trxes(vector<Trx *> & /*trxes*/) {}
...
RC VacuousTrx::update_record(Table *table, Record &record, std::vector<SetVariableSqlNode> *assignments)
{
  return table->update_record(record, assignments);
};
